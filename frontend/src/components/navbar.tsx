...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center px-6 py-4 bg-black/10 backdrop-blur-md backdrop-saturate-150 border border-black/10 shadow-lg">
        ...
        <div className="flex justify-center items-center gap-6">
            ...
            <div className="bg-blue-900 px-4 py-2 rounded-[10px] text-white font-bold hover:bg-blue-800 transition-colors duration-150 animate-pulse cursor-default">
                Get Started
            </div>
        </div>
    </div>
